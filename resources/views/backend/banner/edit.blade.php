...
@section ('title', trans('labels.backend.banner.management') . ' | ' . trans('labels.backend.banner.edit'))

@section('page-header')
<h1>
    {{ trans('labels.backend.banner.management') }}
    <small>{{ trans('labels.backend.banner.edit') }}</small>
</h1> 
...
<div class="row">
    ...
    <div class="col-md-12">
        {{ Form::model($banner, ['route' => ['admin.banner.update', $banner], 'class' => 'form-horizontal', 'role' => 'form' ,'files'=>true, 'method' => 'PATCH', 'id' => 'edit-banner']) }}

        <div class="box box-success">
            <div class="box-header with-border">
                <h3 class="box-title">{{ trans('labels.backend.banner.edit') }}</h3>
            </div><!-- /.box-header -->
